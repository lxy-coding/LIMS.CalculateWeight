...
{
    public class VDCraneVisitor:VisitorBase
    {
        /// <summary>
        /// 空包放吊
        /// </summary>
        ...
        public override void FullDrop(ActionHandlerBase handler)
        {
            ...
            InsertVDInWeightRecord(handler.Record);
        }
        ...
        public override void FullHoist(ActionHandlerBase handler)
        {
            ...
            InsertVDOutWeightRecord(handler.Record);
        }
        ...
        private void InsertVDInWeightRecord(CRANE_ACTION_RECORD_X record)
        {
        ...
        /// <param name="record"></param>
        /// <param name="type"></param>
        private void InsertVDOutWeightRecord(CRANE_ACTION_RECORD_X record)
        {
            WST_WEIGHT_RECORD wRecord = new WST_WEIGHT_RECORD()
            {
                CRA = record.CRA_ID.CRA_NUM,

...
namespace LIMS.Model.EntityModel {
    ...
    [ActiveRecord()]
    public class Ama621 : ActiveRecordValidationBase<Ama621> {
        ...
        [Property(Column="FURNACE_BATCH_NO", Length=40)]
        public virtual string FurnaceBatchNo { get; set; }
        ...
        [Property(Column="FIX_SLAB_NUM", Length=8)]
        public virtual string FixSlabNum { get; set; }
        
        [Property(Column="MAT_TUBE", Length=14)]
        public virtual string MatTube { get; set; }
        ...
        [Property(Column="MAT_CUT_TEMP", Length=8)]
        public virtual string MatCutTemp { get; set; }
        
        [Property(Column="MAT_COLD_BED_TEMP", Length=8)]
        public virtual string MatColdBedTemp { get; set; }
        
        [Property(Column="HISPEED_ROLLTABLE_START", Length=100)]
        public virtual string HispeedRolltableStart { get; set; }
        
        [Property(Column="QUALITY_ABN_CODE", Length=40)]
        public virtual string QualityAbnCode { get; set; }
        
        [Property(Column="HDR_STD", Length=40)]
        public virtual string HdrStd { get; set; }
        ...
        [Property(Column="PRE_FURNACE_BATCH", Length=40)]
        public virtual string PreFurnaceBatch { get; set; }
    }
}

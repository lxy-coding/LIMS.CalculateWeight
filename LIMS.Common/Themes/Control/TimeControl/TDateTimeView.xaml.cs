...
namespace LIMS.Common.Themes.Control.TimeControl
{
    [System.ComponentModel.DesignTimeVisible(false)]//在工具箱中 隐藏该窗体 20200916 周张智
                                                    /// <summary>
    ...
    public partial class TDateTimeView : UserControl
    {
            ...
            : this()
        {
            ...
            if (!string.IsNullOrEmpty(txt))
            {
                ...
                btnhh.Content = dt.ToString("HH");
                btnmm.Content = dt.ToString("mm");
                btnss.Content = dt.ToString("ss");
            }
